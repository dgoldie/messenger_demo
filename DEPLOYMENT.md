...
sudo service unicorn_messenger_demo <start|stop|restart>
sudo service sidekiq_messenger_demo <start|stop>
```
...
```
/home/deployer/apps/messenger_demo/shared/.env.production
```

After making changes to this file, be sure to restart the application:

```
sudo service unicorn_messenger_demo restart
sudo service sidekiq_messenger_demo stop
sudo service sidekiq_messenger_demo start
```
